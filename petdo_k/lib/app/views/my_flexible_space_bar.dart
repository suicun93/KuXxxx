  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        final MyFlexibleSpaceBarSettings settings = context
            .dependOnInheritedWidgetOfExactType<MyFlexibleSpaceBarSettings>()!;
        assert(
          settings != null,
        ...
        if (widget.title != null) {
          ...
          if (opacity > 0.0) {
            ...
            final double scaleValue =
                Tween<double>(begin: 1.2, end: 1.0).transform(t);
